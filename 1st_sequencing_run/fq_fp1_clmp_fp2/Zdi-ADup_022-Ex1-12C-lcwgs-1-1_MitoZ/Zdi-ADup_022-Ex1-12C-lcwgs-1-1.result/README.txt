...
File:
errorsummary.val
Zdi-ADup_022-Ex1-12C-lcwgs-1-1_mitoscaf.fa.val
...
File:
Zdi-ADup_022-Ex1-12C-lcwgs-1-1_mitoscaf.fa.gbf

- 4. The mitochondrial genome in Fasta format.
File:
Zdi-ADup_022-Ex1-12C-lcwgs-1-1.fasta
...
the file Zdi-ADup_022-Ex1-12C-lcwgs-1-1_mitoscaf.fa.gbf has no annotation problem.
File:
Zdi-ADup_022-Ex1-12C-lcwgs-1-1_mitoscaf.fa.sqn

- 7. The feature table for the mitochondrial genome.
File:
Zdi-ADup_022-Ex1-12C-lcwgs-1-1_mitoscaf.fa.tbl
...
File:
Zdi-ADup_022-Ex1-12C-lcwgs-1-1.cds

- 9. The rRNA gene sequences for each rRNA gene.
File:
Zdi-ADup_022-Ex1-12C-lcwgs-1-1.rrna

- 10. The tRNA gene sequences for each tRNA gene.
File:
Zdi-ADup_022-Ex1-12C-lcwgs-1-1.trna

- 11. The control region sequence.
File:
Zdi-ADup_022-Ex1-12C-lcwgs-1-1.misc_feature
