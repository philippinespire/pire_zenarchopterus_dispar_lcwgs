...
File:
errorsummary.val
Zdi-CDup_016-Ex1-7B-lcwgs-1-2_mitoscaf.fa.val
...
File:
Zdi-CDup_016-Ex1-7B-lcwgs-1-2_mitoscaf.fa.gbf

- 4. The mitochondrial genome in Fasta format.
File:
Zdi-CDup_016-Ex1-7B-lcwgs-1-2.fasta
...
the file Zdi-CDup_016-Ex1-7B-lcwgs-1-2_mitoscaf.fa.gbf has no annotation problem.
File:
Zdi-CDup_016-Ex1-7B-lcwgs-1-2_mitoscaf.fa.sqn

- 7. The feature table for the mitochondrial genome.
File:
Zdi-CDup_016-Ex1-7B-lcwgs-1-2_mitoscaf.fa.tbl
...
File:
Zdi-CDup_016-Ex1-7B-lcwgs-1-2.cds

- 9. The rRNA gene sequences for each rRNA gene.
File:
Zdi-CDup_016-Ex1-7B-lcwgs-1-2.rrna

- 10. The tRNA gene sequences for each tRNA gene.
File:
Zdi-CDup_016-Ex1-7B-lcwgs-1-2.trna

- 11. The control region sequence.
File:
Zdi-CDup_016-Ex1-7B-lcwgs-1-2.misc_feature
