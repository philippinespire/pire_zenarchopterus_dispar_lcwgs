...
### This directory has been abandoned due to file errors. (October 28 2024)
---
...
* **3624828:**
    * more errors involving `Xenentodon_cancila` but we cannot identify the issue. I have to remove that species, and make a new GenErode folder.
    * New [2nd GenErode directory](https://github.com/philippinespire/pire_zenarchopterus_dispar_lcwgs/tree/main/abandoned_GenErode_Zdi_2)
